#include "EngineRenderer/TextureManager/cBasicTextureManager.h"
...
GLuint cBasicTextureManager::GetSamplerId(eTextureType textureType)
{
	if (textureType == eTextureType::COLOR)
	{
		...
		myutils::WrapMinMax(0, MAX_COLOR_SAMPLER, m_nextColorSamplerId);
...
sSamplerInfo* cBasicTextureManager::GetSamplerInfo(ShaderManager::ShaderProgram* pShaderProgram, eTextureType textureTypeIn)
{
	...
	{
		samplerName = "transparencyTexture";
		samplerRatioName = "";
		samplerToggle = "bUseTransparencyTexture";
	}
